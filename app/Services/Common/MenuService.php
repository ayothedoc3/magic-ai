    ...
    public function mergeExtensionMenu($menu)
    {
        ...
        $menu = array_merge($menu, [
            ...
            'seo_automation' => [
                ...
                'show_condition' => config('seo.enabled', true),
                'bolt_menu'        => true,
                'bolt_background'  => 'bg-gradient-to-br from-green-400 to-emerald-600',
                'bolt_foreground'  => 'text-white',
            ],
            'seo_projects' => [
                'parent_key'       => 'seo_automation',
                'key'              => 'seo_projects',
            ...
            'seo_analytics' => [
                'parent_key'       => 'seo_automation',
                'key'              => 'seo_analytics',
                'route'            => 'seo.analytics.index',
                'label'            => 'Analytics & Indexing',
