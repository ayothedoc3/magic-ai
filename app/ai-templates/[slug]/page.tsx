...
async function loadPage(slug: string) {
  return getPseoPageByRoute({ pageType: GeneratedPageType.TEMPLATE, slug });
}
...
export async function generateMetadata({
  ...
  if (!page) {
    return {
      title: "AI Template Not Found | AyoMagic",
...
export default async function AiTemplatePseoPage({
  params,
}: {
  params: { slug: string };
}) {
