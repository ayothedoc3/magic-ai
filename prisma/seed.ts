import { PrismaClient, Role, PlanInterval } from "@prisma/client";
      ...
      fields: [
        {
          ...
          label: "Email Type",
          type: "select",
          options: ["Marketing", "Welcome", "Follow-up", "Newsletter", "Cold Outreach"],
          required: true,
        },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: "topic", label: "Topic", type: "text", required: true },
        {
          ...
          label: "Style",
          type: "select",
          options: ["Informative", "Engaging", "Promotional", "Thought Leadership"],
          required: false,
        },
      ],
    },
    {
      ...
      fields: [
        ...
        { name: "target", label: "Target Customer", type: "text", required: false },
        {
          ...
          label: "Tone",
          type: "select",
          options: ["Professional", "Luxury", "Casual", "Technical"],
          required: false,
        },
      ],
    },
      ...
      fields: [
        {
          ...
          type: "select",
          options: ["TypeScript", "Python", "JavaScript", "Go", "Rust", "SQL"],
          required: true,
        },
